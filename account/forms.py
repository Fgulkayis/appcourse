...
class NewUserForm(UserCreationForm):
      ...
      def __init__(self,*args,**kwargs):
           ...
           self.fields["username"].widget =widgets.TextInput(attrs={"class":"form-control"})
           self.fields["first_name"].widget =widgets.PasswordInput(attrs={"class":"form-control"})
           self.fields["last_name"].widget =widgets.PasswordInput(attrs={"class":"form-control"})
      ...
      def clean_email(self):
         ...
         if User.objects.filter(email =email).exists():
            self.add_error["email","email daha önce kullanılmmış"]
         return email
